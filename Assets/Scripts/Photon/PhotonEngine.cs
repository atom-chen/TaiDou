...
public class PhotonEngine : MonoBehaviour, IPhotonPeerListener
{
    ...
    public string applicationName = "MyGame1";
    ...
    {
        Logger.Log("sendrequest to server , opcode : " + opCode + " subCode:  " + subCode);
    ...
    public void OnEvent(EventData eventData)
    {
        ...
        {
            Logger.Log("Receive a unknown event . OperationCode: " + opCode);
        }
    }
    ...
    {
        Logger.Log("OnStatusChanged:" + statusCode);
        switch (statusCode)
        {
