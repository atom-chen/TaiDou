...
public static class NGUIEditorTools
{
    ...
    //static public void DrawSprite(Texture tex, Rect rect, UISpriteData sprite, Color color)
    //{
    ...
    //static public void DrawSprite(Texture tex, Rect drawRect, UISpriteData sprite, Color color, Material mat)
    //{
    ...
    //}
    //2015/5/5:ld
    static public void DrawSprite(Texture tex, Rect drawRect)
    {
        DrawSprite(tex, drawRect, null);
    }
    static public void DrawSprite(Texture tex, Rect drawRect, Material mat)
    {
        if (!tex) return;

        // Create the texture rectangle that is centered inside rect.
        Rect outerRect = drawRect;
        outerRect.width = drawRect.width;
        outerRect.height = tex.height * drawRect.width / tex.width;
        ...
        if (Selection.activeGameObject == null || Selection.gameObjects.Length == 1)
        {
            ...
            // Sprite size label
            string text = string.Format("Sprite Size: {0}x{1}", Mathf.RoundToInt(tex.width), Mathf.RoundToInt(tex.height));
    ...
    static public void DrawSprite(Texture tex, Rect drawRect, Color color, Rect textureRect, Vector4 border)
    {
    ...
    static public void DrawSprite(Texture tex, Rect drawRect, Color color, Material mat,
